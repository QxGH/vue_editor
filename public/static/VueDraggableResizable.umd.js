...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d837d146-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/vue-draggable-resizable.vue?vue&type=template&id=4429b9a4&
var render = function () {
var _obj;
...
// CONCATENATED MODULE: ./src/components/vue-draggable-resizable.vue?vue&type=template&id=4429b9a4&
...
/* harmony default export */ var vue_draggable_resizablevue_type_script_lang_js_ = ({
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this.rawRight = this.right; // 初始化辅助线数据
    ...
    snapToGrid: function snapToGrid(grid, pendingX, pendingY) {
      ...
      var y = Math.round(pendingY / grid[1]) * grid[1]; // return [x, y]
    ...
    settingAttribute: function settingAttribute() {
      // 设置冲突检测
      this.isConflictCheck ? this.$el.setAttribute('data-is-check', 'true') : this.$el.setAttribute('data-is-check', 'false'); // 设置对齐元素
        ...
        try {
          for (var _iterator = nodes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (item.className !== undefined && !item.className.includes(this.classNameActive) && item.getAttribute('data-is-check') !== null && item.getAttribute('data-is-check') !== 'false') {
              ...
              var th = item.offsetHeight;
              var tl = item.offsetLeft;
              var tt = item.offsetTop; // 左上角与右下角重叠
    ...
    snapCheck: function () {
      ...
      regeneratorRuntime.mark(function _callee2() {
        var width, height, activeLeft, activeRight, activeTop, activeBottom, temArr, refLine, i, nodes, tem, _ref, groupWidth, groupHeight, groupLeft, groupTop, bln, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, item, w, h, l, r, t, b, hc, vc, ts, TS, bs, BS, ls, LS, rs, RS, arrTem, _i, xory, horv, _this$calcLineValues, origin, length;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                activeLeft = this.rawLeft;
                activeRight = this.rawLeft + width;
                activeTop = this.rawTop;
                activeBottom = this.rawTop + height; // 初始化辅助线数据
              ...
              case 14:
                ...
                for (_iterator2 = nodes[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                  ...
                  if (item.className !== undefined && !item.className.includes(this.classNameActive) && item.getAttribute('data-is-snap') !== null && item.getAttribute('data-is-snap') !== 'false') {
                    w = item.offsetWidth;
                    h = item.offsetHeight;
                    l = item.offsetLeft; // 对齐目标的left

                    r = l + w; // 对齐目标right

                    t = item.offsetTop; // 对齐目标的top
        ...
        }, _callee2, this, [[24, 28, 32, 40], [33,, 35, 39]]);
      }));
    ...
    getActiveAll: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3(nodes) {
        ...
        }, _callee3, this, [[10, 14, 18, 26], [19,, 21, 25], [31, 35, 39, 47], [40,, 42, 46]]);
      }));

      function getActiveAll(_x2) {
